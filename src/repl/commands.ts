...
export const COMMAND_DEFS: ReadonlyArray<CommandDef> = [
  ...
  { name: 'model',    signature: '/model [provider model | default [provider model] | refresh]', summary: 'Pick a model for this session; "default" saves the launch default; "refresh" refetches provider lists', args: 'optional' },
  ...
  { name: 'commit',   signature: '/commit [message]',                         summary: 'Stage everything and commit (message written for you)',     args: 'optional' },
  ...
  { name: 'hooks',    signature: '/hooks',                                    summary: 'List the hooks active in this session, by event',           args: 'none' },
  { name: 'memory',   signature: '/memory [forget <name>]',                   summary: 'Show what autocode remembers about this project',            args: 'optional' },
  { name: 'spinner',  signature: '/spinner [name]',                           summary: 'Show or set the active spinner',                            args: 'optional' },
  { name: 'computer-use', signature: '/computer-use [on|off]',                 summary: 'Enable or disable computer-use verification tools',         args: 'optional' },
  { name: 'ui',       signature: '/ui [inline|cockpit|dark|light]',           summary: 'Switch TUI mode (inline/cockpit) or theme',                 args: 'optional' },
  { name: 'refresh',  signature: '/refresh',                                  summary: 'Rebuild the repo map (after external file changes)',        args: 'none' },
